...
| `--ystd--headline--font-weight` | `700` |
| `--ystd--headline--font-weight--h1` | `var(--ystd--headline--font-weight)` |
| `--ystd--headline--font-weight--h2` | `var(--ystd--headline--font-weight)` |
| `--ystd--headline--font-weight--h3` | `var(--ystd--headline--font-weight)` |
| `--ystd--headline--font-weight--h4` | `var(--ystd--headline--font-weight)` |
| `--ystd--headline--font-weight--h5` | `var(--ystd--headline--font-weight)` |
| `--ystd--headline--font-weight--h6` | `var(--ystd--headline--font-weight)` |
