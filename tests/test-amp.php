...
<amp-twitter width=486 height=657 layout="responsive" data-tweetid="969776900804694016"></amp-twitter>
<amp-instagram layout="responsive" data-shortcode="BeRQMOslbMe" width="400" height="400" ></amp-instagram>
<amp-instagram layout="responsive" data-shortcode="BeRQMOslbMe" width="400" height="400" ></amp-instagram>
...
<amp-twitter width=486 height=657 layout="responsive" data-tweetid="969776900804694016"></amp-twitter>' . PHP_EOL,
	...
	/**
	 * instagram変換テスト oembed
	 */
	function test_amp_instagram_oembed() {
		$content = 'https://www.instagram.com/p/BeRQMOslbMe/?taken-by=yosiakatsuki';
		$content = $this->apply_the_content( $content );
		$content = ys_amp_convert_instagram( $content );
		$content = ys_amp_delete_script( $content );
		$this->assertSame(
						'<amp-instagram layout="responsive" data-shortcode="BeRQMOslbMe" width="400" height="400" ></amp-instagram>' . PHP_EOL,
						$content
					);
	}
	/**
